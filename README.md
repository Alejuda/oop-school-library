...
The Librarian's Terminal Tracker is a sophisticated Ruby application designed to streamline the management of OOP University's vast library collection. As the librarian, you can now efficiently track and organize the books available, borrowers, and due dates, all from the convenience of your terminal.
...
```
git clone git@github.com:Alejuda/oop-school-library.git
```

Using HTTPS:

```
git clone https://github.com/Alejuda/oop-school-library.git
```
...
Feel free to check the [issues page](https://github.com/Alejuda/oop-school-library/issues).
...
If you encounter any issues or have any questions or suggestions, please open an issue on the [issue tracker](https://github.com/Alejuda/oop-school-library/issues).
